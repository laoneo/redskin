...
/**
 * This is the item provider adapter for a {@link ch.allon.redskin.core.model.shop.Order} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class OrderItemProvider
	...
	protected void addCommentsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Order_comments_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Order_comments_feature", "_UI_Order_type"),
				 ShopPackage.Literals.ORDER__COMMENTS,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShopPackage.Literals.ORDER__TRANSACTIONS);
		}
