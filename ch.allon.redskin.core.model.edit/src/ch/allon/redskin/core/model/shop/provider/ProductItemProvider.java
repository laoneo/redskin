...
/**
 * This is the item provider adapter for a {@link ch.allon.redskin.core.model.shop.Product} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProductItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ShopPackage.Literals.PRODUCT__NAME,
				 true,
				 false,
				 false,
	...
	protected void addNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Product_number_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Product_number_feature", "_UI_Product_type"),
				 ShopPackage.Literals.PRODUCT__NUMBER,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ShopPackage.Literals.PRODUCT__DESCRIPTION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ShopPackage.Literals.PRODUCT__TRANSACTIONS);
		}
	...
	public String getText(Object object) {
		...
		sb.append(p.getNumber() == null ? "" : " [" + p.getNumber() + "]");
		return sb.length() == 0 ? getString("_UI_Product_type") : sb.toString();
	}
		...
		newChildDescriptors.add
			(createChildParameter
				(ShopPackage.Literals.PRODUCT__TRANSACTIONS,
				 ShopFactory.eINSTANCE.createTransaction()));
	}
